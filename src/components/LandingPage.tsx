...
export const LandingPage = () => {
  return (
    <div className="m-4 font-DmSans bg-white">
      <div className="grid lg:grid-cols-4 lg:grid-rows-2 auto-rows-auto lg:h-[180svh]  lg:gap-10 gap-5  overflow-hidden relative w-full w-dvh">
        ...
        <div className="bg-purple-100 lg:col-span-1 lg:row-span-2 rounded-xl overflow-hidden row-start-4">
          <div className="p-6 flex flex-col lg:justify-between justify-center gap-4 items-center  w-full">
        ...
        <div className="bg-yellows-500  rounded-xl shadow-lg overflow-hidden lg:row-auto row-start-3">
          <div className="p-6 flex flex-col justify-center lg:items-center items-start gap-8  my-4">
        ...
        <div className="bg-yellows-500 lg:col-span-1  rounded-xl overflow-hidden lg:row-start-2 lg:row-end-4  lg:mt-[10rem]">
        ...
        <div className="bg-purples-500 lg:col-span-2 rounded-xl row-start-5">
          <div className="p-6 flex lg:flex-row flex-col items-center gap-4 text-white text-4xl font-medium ">
